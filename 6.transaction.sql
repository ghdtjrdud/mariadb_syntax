...
-- post에 글쓴후에, author 테이블에 post_count값에 +1 을 시키는 트랙잭션 테스트
start transaction;
update author set post_count = post_count +1 where 4 = 100;
...
DELIMITER //
CREATE PROCEDURE 트랜잭션테스트2(in titleInput varchar(255),
